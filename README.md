...
## Scope
- The GPU will be FPGA-based, incorporating specialized processing units.
...
- Build a control unit for the GPU that can interface with either a serial or PCIe connection.
